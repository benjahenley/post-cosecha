...
export default function ProductCardSingle(props: Product) {
  return (
    <div
      ...
      className={`group p-4 max rounded-lg text-[4rem] items-center flex xl:flex-row xl:items-start justify-between h-auto select-none pt-5 flex-col py-5 max-w-screen-lg w-full`}>
      ...
      <div className="lg:ml-10 flex flex-col items-left mt-5 px-2 w-full">
        <SectionTitle className="mb-5 text-center text-white">
          {props.title}
        </SectionTitle>
