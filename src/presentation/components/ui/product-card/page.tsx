...
export default function ProductCard(props: Product) {
  ...
  return (
    <div
      ...
      <TextAllwaysBlack className="rounded-full border-2 border-black group-hover:border-white px-2 mb-5 uppercase group-hover:font-semibold tracking-wider group-hover:text-white">
        {props.title}
      </TextAllwaysBlack>
