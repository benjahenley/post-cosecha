...
export default function ProductCard(props: Product) {
  ...
  return (
    <div
      ...
      }   hover:scale-[.99] transition-[shadow,scale,bg,bg-opacity] hover:bg-black hover:bg-opacity-50 transition-scale duration-500 group cursor-pointer bg-opacity-10 p-4 max rounded-lg text-[4rem] font-semibold flex items-center justify-center h-auto select-none pt-5 flex-col py-5 `}>
      ...
      <TextAllwaysBlack className="rounded-full border-2 border-black group-hover:border-white px-2 mt-5 uppercase group-hover:font-semibold tracking-wider group-hover:text-white">
        {props.title}
      </TextAllwaysBlack>
